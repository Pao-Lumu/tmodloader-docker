...
RUN curl -SLO "https://web.archive.org/web/20191121062312/http://terraria.org/system/dedicated_servers/archives/000/000/032/original/terraria-server-${TERRARIA_VERSION}.zip" &&\
